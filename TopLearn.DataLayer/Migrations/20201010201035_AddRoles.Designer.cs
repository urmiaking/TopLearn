...
namespace TopLearn.DataLayer.Migrations
{
    ...
    [Migration("20201010201035_AddRoles")]
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterDate = new DateTime(2020, 10, 10, 23, 40, 34, 530, DateTimeKind.Local).AddTicks(3509)
                        });
                });
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.Wallet.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsPaid = true,
                            TransactionDate = new DateTime(2020, 10, 10, 23, 40, 34, 534, DateTimeKind.Local).AddTicks(5108),
                            TransactionType = 1,
                            UserId = 1
                        },
                        new
                        {
                            ...
                            Description = "شارژ حساب",
                            IsPaid = true,
                            TransactionDate = new DateTime(2020, 10, 10, 23, 40, 34, 534, DateTimeKind.Local).AddTicks(9034),
                            TransactionType = 1,
                            UserId = 1
                        },
                        new
                        {
                            ...
                            IsPaid = true,
                            TransactionDate = new DateTime(2020, 10, 10, 23, 40, 34, 534, DateTimeKind.Local).AddTicks(9133),
                            TransactionType = 0,
                            UserId = 1
                        });
                });
